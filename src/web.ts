...
const TOOLS = [
  ...
  },
  {
    ...
    tools: [
      ...
      { name: "obsidian_delete", desc: "Delete a note, auto-syncs to git" },
      { name: "obsidian_move", desc: "Move or rename a note, auto-syncs to git" },
      { name: "obsidian_list", desc: "List all notes in the vault or a subdirectory" },
      { name: "obsidian_search", desc: "Search all notes with surrounding context" },
      { name: "obsidian_frontmatter", desc: "Read or update YAML frontmatter of a note" },
      { name: "obsidian_links", desc: "Get outgoing wikilinks and incoming backlinks" },
      { name: "obsidian_pull", desc: "Pull latest changes from git before reading" },
    ],
  },
  {
    group: "github",
  ...
  },
  {
    ...
    label: "SLURM",
    tools: [
      { name: "slurm_run", desc: "Run a shell command on the HPC cluster via SSH" },
      { name: "slurm_jobs", desc: "List SLURM jobs in the queue" },
      { name: "slurm_files", desc: "List files in a remote directory" },
      { name: "slurm_read_file", desc: "Read a file from the HPC cluster" },
      { name: "slurm_submit_job", desc: "Submit a SLURM batch job script" },
      { name: "slurm_storage", desc: "Check disk quota and storage usage" },
    ],
  },
  {
    group: "ollama",
